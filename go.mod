module github.com/005-bot/tg-bot-go

go 1.25.7

require (
	github.com/005-bot/address-parser-go v0.0.2
	github.com/005-bot/apis-go v0.0.1
	...
	github.com/go-core-fx/telegofx v0.2.1-0.20260820033705-b60bf8b3d438
